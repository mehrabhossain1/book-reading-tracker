...
export default async function AppLayout({ children }: LayoutProps<"/">) {
  ...
  return (
    // px-safe-0: the whole app sits inside the notch-safe area in iPhone
    // landscape. The ground is one flat colour, so nothing visibly stops short.
    <div className="px-safe-0 flex min-h-dvh flex-1 flex-col">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        {/* Mobile: top bar */}
        <header className="bg-background/90 border-border pt-safe-2.5 sticky top-0 z-30 flex items-center justify-between border-b px-4 pb-2.5 backdrop-blur-md md:hidden">
          <Brand />
